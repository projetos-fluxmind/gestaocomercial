/**
 * Commission Engine — Calcula comissão por venda com base nas regras do plano.
 * Multi-tenant: sempre recebe company_id para isolamento.
 */
...
/**
 * Calcula a comissão total para uma venda dado o plano e suas regras.
 */
export function calculateCommission(sale: Sale, plan: Plan): CommissionResult {
